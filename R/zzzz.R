...
.onAttach <- function(libname, pkgname) {
  packageStartupMessage(
    ...
    "Psychoneuroendocrinology, 107584. https://doi.org/10.1016/j.psyneuen.2025.107584"
  )
}
