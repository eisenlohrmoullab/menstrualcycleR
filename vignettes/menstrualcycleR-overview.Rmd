...
2. **summary**: A summary of the outcome variable at each 5% increment of the scaled cycle timeline.
...
`cycle_plot_individual()` returns a list with three components:
