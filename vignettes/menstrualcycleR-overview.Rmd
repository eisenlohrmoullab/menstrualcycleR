...
Note: If outcomes of interest are not collected daily from participants, but on an every-other-day basis or weekly, the outcomes may still be scaled. The dataset just needs to be in long format with a calendar date for each observation and cycle variables of `menses` and `ovtoday`. 
---
