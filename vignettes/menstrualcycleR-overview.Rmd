...
Additionally, `menstrualcycleR` will only scale luteal phases if the length is **between 7 and 18 days**. This judgement is based on norms from over 600,000 ovulatory cycles reported in Bull et al., (2019). 
