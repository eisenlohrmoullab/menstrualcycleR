...
`lower_cyclength_bound` / `upper_cyclength_bound` (default **21-35 days**) control whether **ovulation is imputed** for a cycle that has no confirmed ovulation. Cycles outside the range are not given an imputed ovulation, because they show greater variability in timing and an increased likelihood of anovulation.
